...
function creativefolk_setup() {
	 ...
	 * If you're building a theme based on CreativeFolk, use a find and replace
	 * to change 'creativefolk' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'creativefolk', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'creativefolk' ),
	) );
 ...
 */
function creativefolk_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'creativefolk' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'creativefolk_widgets_init' );
